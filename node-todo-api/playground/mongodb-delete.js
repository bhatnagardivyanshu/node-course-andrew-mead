...
//   const documents = await db.collection('Todos').deleteMany({completed: false}); // delete many documents
//   const documents = await db.collection('Todos').deleteOne({_id: ObjectID("5bf8071cb3911e5a9cd21f55")}); // delete single documents
  ...
  console.log('Documents deleted:', JSON.stringify(documents, undefined, 4));
